...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO MECOO API!') // boleh diubah
}

var creatorList = ['Mecoo']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'Mecoo' // Apikey Lu Ngab
...
// Api Features :
        ...
        var randomTextNumber = random+randomlagi+'---------kuhong-api-storage'+'Mecoo';
